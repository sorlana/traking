...
<head>
    ...
    <link rel="stylesheet" href="<?= url('/assets/css/app.css') ?>?v=28">
</head>
<body class="min-h-screen flex flex-col bg-white lg:bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-10 md:h-16">
                ...
                <div class="hidden md:flex items-center gap-4">
                    ...
                    <!-- Настройки -->
                    <a href="<?= url('/settings') ?>" class="desktop-header-icon p-1 relative" title="Настройки">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <nav class="mobile-bottom-nav md:hidden fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg z-50" x-data="{ moreOpen: false }">
        <div class="flex items-center h-14">
            ...
            <!-- Ещё -->
            <button @click="moreOpen = !moreOpen" class="flex-1 flex flex-col items-center gap-0.5 py-1 <?= str_contains($currentPath, '/settings') || str_contains($currentPath, '/help') || str_contains($currentPath, '/calendar') ? 'text-blue-600' : 'text-gray-500' ?>">
    ...
    <!-- Основное содержимое -->
    <main class="flex-1 max-w-7xl w-full mx-auto px-4 py-4 pb-28 md:pb-4 pt-14 md:pt-20">
        <?= $content ?>
    </main>
